...
echo "Uninstalling the docpagerbot at $folder_name/$deployment_name"
curl -k -X DELETE -u $mantl_user:$mantl_password https://$control_address:8080/v2/apps/$folder_name/$deployment_name/docpagerapp \
